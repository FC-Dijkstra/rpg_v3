...
//Implémentation brute, ne pas prendre en compte
int main2(void)
{
	...
	//comme les deux tableaux sont mis l'un apr�s l'autre, pour retrouver la couleur d'un vertex on d�cale de la taille 
